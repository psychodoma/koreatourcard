...
<header id="hd" style='display:none;'>
    ...
    <div id="hd_wrapper">
        ...
        <div id="logo" style='display:none;'>
            <a href="<?php echo G5_URL ?>"><img src="<?php echo G5_IMG_URL ?>/logo_<?=substr(strtolower($g5['lang']),-2,2)?>.png" alt="<?php echo $config['cf_title']; ?>"></a>
        </div>

        <button type="button" id="gnb_open" class="hd_opener"><?php echo _t('메뉴'); ?><span class="sound_only"> <?php echo _t('열기'); ?></span></button>

        <div id="gnb" class="hd_div" style='display:none;'>
            <ul id="gnb_1dul">
            <?php
            $sql = " select *
                        from {$g5['menu_table']}
        ...
        <div id="hd_sch" class="hd_div" style='display:none;'>
