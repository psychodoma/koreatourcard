...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_com">
            <?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>" class="btn_admin"><?php echo _t('수정'); ?></a></li><?php } ?>
            <?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" class="btn_admin" onclick="del(this.href); return false;"><?php echo _t('삭제'); ?></a></li><?php } ?>
            ...
            <?php if ($search_href) { ?><li><a href="<?php echo $search_href ?>" class="btn_admin"><?php echo _t('검색'); ?></a></li><?php } ?>
            <li><a href="<?php echo $list_href ?>" class="btn_admin"><?php echo _t('목록'); ?></a></li>
            <?php if ($reply_href) { ?><li><a href="<?php echo $reply_href ?>" class="btn_admin"><?php echo _t('답변'); ?></a></li><?php } ?>
