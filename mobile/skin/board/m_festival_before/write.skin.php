...
<script src="<?php echo G5_JS_URL; ?>/jquery.mtz.monthpicker.js"></script>
...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="wr_subject">날짜 선택<strong class="sound_only">필수</strong></label></th>
            <td>
                <input type="text" name='wr_subject' id="demo-3" value='<?=$write['wr_subject']?>' > <input type="button" value="달 선택" id="demo-3-button">
            </td>
