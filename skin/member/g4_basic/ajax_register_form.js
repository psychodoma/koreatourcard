...
function reg_mb_id_check() {
    var url = member_skin_url + "/ajax_mb_id_check.php";
...
function reg_mb_nick_check() {
    var url = member_skin_url + "/ajax_mb_nick_check.php";
...
function reg_mb_email_check() {
    var url = member_skin_url + "/ajax_mb_email_check.php";
    var para = "reg_mb_id="+encodeURIComponent($F('reg_mb_id'));
...
// 세션에 저장된 토큰을 얻는다.
function get_token() {
    var url = member_skin_url + "/ajax_get_token.php";
    var para = "reg_mb_id="+encodeURIComponent($F('reg_mb_id'));
        para += "&reg_mb_email="+encodeURIComponent($F('reg_mb_email'));
    var myAjax = new Ajax.Request(
        url, 
