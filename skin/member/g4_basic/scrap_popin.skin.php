...
<tr>
    <td align="center" valign="middle" bgcolor="#EBEBEB">
        ...
        <tr> 
            ...
            <td width="75" align="left" bgcolor="#FFFFFF" ><font color="#666666"><b><?php echo _t('스크랩하기'); ?></b></font></td>
    ...
    <td height="200" align="center" valign="top"><table width="540" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr> 
                <td width="540" height="2" align="center" valign="top" bgcolor="#FFFFFF"><table width="540" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
                            <td width="80" height="27" align="center"><b><?php echo _t('제목'); ?></b></td>
                            <td width="10" valign="bottom"><img src="<?php echo $member_skin_url?>/img/l.gif" width="1" height="8"></td>
                        ...
                        <tr> 
                            <td width="80" height="200" align="center"><b><?php echo _t('코멘트'); ?></b></td>
                            <td width="10" valign="bottom"><img src="<?php echo $member_skin_url?>/img/l.gif" width="1" height="8"></td>
...
<tr>
    <td height="40" align="center" valign="bottom"><INPUT type=image width="40" height="20" src="<?php echo $member_skin_url?>/img/ok_btn.gif" border=0></td>
</tr>
</form>
</table>
