...
<tr> 
    ...
    <td width="628" align="right" background="<?php echo $member_skin_url?>/img/modify_table_bg_top.gif"><img src="<?php echo $member_skin_url?>/img/modify_img.gif" width="344" height="48"></td>
    <td width="20"></td>
</tr>
<tr> 
    <td width="20" height="223"></td>
    <td width="628" align="center" background="<?php echo $member_skin_url?>/img/modify_table_bg.gif">
        ...
        <tr> 
            <td width="460" height="223" align="center" bgcolor="#FFFFFF">
                ...
                <tr> 
                    <td width="250">
                        ...
                        <tr> 
                            ...
                            <td width="90" height="26"><b><?php echo _t('회원아이디'); ?></b></td>
                    ...
                    <td width="100" valign="top"><INPUT name="image" type=image src="<?php echo $member_skin_url?>/img/ok_button.gif" width="65" height="52" border=0 id="btn_submit"></td>
                </tr>
                <tr> 
                ...
                <table>
                <tr align="center"> 
                    <td height="80" colspan="2"><?php echo _t('외부로부터 회원님의 정보를 안전하게 보호하기 위해'); ?><br><?php echo _t('패스워드를 확인하셔야 합니다.'); ?></td>
                </tr>
                </table></td>
        </tr>
        </table></td>
