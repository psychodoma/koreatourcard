                ...
                <tr>
                    <td width="250">
                        ...
                        <tr>
                            ...
                            <td><INPUT type=password class=ed maxLength=20 size=15 name=mb_password id="login_mb_password" itemname="<?php echo _t('패스워드'); ?>" required onkeypress="check_capslock(event, 'login_mb_password');"></td>
                        </tr>
                        <tr>
                            <td><img src="<?php echo $member_skin_url?>/img/icon.gif" width="3" height="3"></td>
