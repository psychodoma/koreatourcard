...
?>
		...
		<div class="sub1_3center">
				...
				<tr>
					<td class="title">
						...
						<p>
                            <?php
                                if ($category_name) echo $view['ca_name'].' | '; // 분류 출력 끝
								//echo $view['wr_datetime'];
								echo substr($view['wr_datetime'],0,10);
								echo "&nbsp;&nbsp;&nbsp;&nbsp;";
								echo substr($view['wr_datetime'],11,20);
			...
			<table class="sub1_3table_bottom">
				...
				<tr>
					<td class="prev">
						<a href="<?php echo "/bbs/board.php?bo_table=event&wr_id=".$prev_page_info_result['wr_id']."&me_code=".$me_code."&info=".$info."&num=".$num.lang_url_a($_SESSION['lang']); ?>">
							<div class="title">	
								<h4><?=_t('이전글')?></h4>
				...
				<tr>
					<td class="next">
						<a href="<?php echo "/bbs/board.php?bo_table=event&wr_id=".$next_page_info_result['wr_id']."&me_code=".$me_code."&info=".$info."&num=".$num.lang_url_a($_SESSION['lang']); ?>">
							<div class="title">	
								<h4><?=_t('다음글')?></h4>
