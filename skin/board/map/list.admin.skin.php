...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <?php } ?>
            <th scope="col"><?php echo _t('판매점 주소'); ?></th>
            <th scope="col"><?php echo _t('판매점'); ?></th>
            <th scope="col"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?><?php echo _t('날짜'); ?></a></th>
            <th scope="col"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?><?php echo _t('번호'); ?></a></th>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <?php } ?>
            <td class="td_subject" style='width:40%;'>
                <?php
                ...
                <a href="/adm/bbs/write.php?w=u&bo_table=<?=$bo_table?>&wr_id=<?php echo $list[$i]['wr_id'] ?>&page=<?=$page?>sst=<?=$sst?>&sod=<?=$sod?>&sfl=<?=$sfl?>&stx=<?=$stx?>&page=<?=$page?>">
                    <?php echo $list[$i]['info_address_ko_KR'] ?>
            ...
            <td class="td_name sv_use" style='width:30%;'>
				<a href="/adm/bbs/write.php?w=u&bo_table=<?=$bo_table?>&wr_id=<?php echo $list[$i]['wr_id'] ?>&page=<?=$page?>sst=<?=$sst?>&sod=<?=$sod?>&sfl=<?=$sfl?>&stx=<?=$stx?>&page=<?=$page?>">
					<?php echo $list[$i]['info_name_ko_KR'] ?>
				</a>
			</td>
            <td class="td_date" style='width:10%;'><?php echo $list[$i]['datetime2'] ?></td>
            <td class="td_num"><?php echo $list[$i]['info_phone'] ?></td>
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_admin"><?php echo _t('글쓰기'); ?></a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <?php } ?>
