...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                <div id="autosave_wrapper" class="trafficWrite_name">
        ...
        <tr>
            <th scope="row"><label for="wr_link<?php echo $i ?>"><?if($i==1) echo "이동 url"; else echo "동 url";?></label></th>
            <td><input type="text" name="wr_link<?php echo $i ?>" value="<?php if($w=="u"){echo$write['wr_link'.$i];} ?>" id="wr_link<?php echo $i ?>" class="frm_input" size="50"></td>
        </tr>
        <?php } ?>-->

        <tr>
            <th scope="row"><label>한국 url</label></th>
            <td><input type="text" name="wr_1" value="<?=$wr_1?>"  class="frm_input" size="100"></td>
        </tr>

        <tr>
            <th scope="row"><label>영어 url</label></th>
            <td><input type="text" name="wr_2" value="<?=$wr_2?>"  class="frm_input" size="100"></td>
        </tr>

        <tr>
            <th scope="row"><label>일본 url</label></th>
            <td><input type="text" name="wr_3" value="<?=$wr_3?>"  class="frm_input" size="100"></td>
        </tr>

        <tr>
            <th scope="row"><label>간체 url</label></th>
            <td><input type="text" name="wr_4" value="<?=$wr_4?>"  class="frm_input" size="100"></td>
        </tr>

        <tr>
            <th scope="row"><label>번체 url</label></th>
            <td><input type="text" name="wr_5" value="<?=$wr_5?>"  class="frm_input" size="100"></td>
        </tr>
