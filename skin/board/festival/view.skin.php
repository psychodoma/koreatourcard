		...
		<div class="sub1_3center">
			...
			<table class="sub4_6table_view">
				<thead>
					...
					<th width="180px" class="smtxt">작성일&nbsp; <?=substr($view['wr_datetime'],0,10);?></th>	
					<th width="100px" class="smtxt">조회 <?=$view['wr_hit']?></th>	
				</thead>
			...
			<table class="sub1_3table_bottom">
				...
				<tr>
					<td class="prev">
						<a href="<?php echo $prev_href."/bbs/board.php?bo_table=".$_GET['bo_table']."&wr_id=".$prev_page_info_result['wr_id']."&me_code=".$me_code."&info=".$info."&num=".$num; ?>">
							<div class="title">	
								<h4>이전글</h4>
				...
				<tr>
					<td class="next">
						<a href="<?php echo $next_href."/bbs/board.php?bo_table=".$_GET['bo_table']."&wr_id=".$next_page_info_result['wr_id']."&me_code=".$me_code."&info=".$info."&num=".$num; ?>">
							<div class="title">	
								<h4>다음글</h4>
