...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <th scope="col"><?php echo subject_sort_link('wr_1', $qstr2, 1) ?><?php echo _t('기간'); ?></a></th>
	...
	<style>
		.btn{padding:5px 20px;border-radius:5px;background:#ff6600;}
	</style>
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_adm">
			...
			<li><a href="javascript:window.open('<?=G5_ADMIN_BBS_URL?>/upxls.php','excel_upload','width=500px,height=800px');" class="btn_admin btn">엑셀업로드</a></li>
