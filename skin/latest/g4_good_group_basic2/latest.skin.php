...
<div class="sideTable">
   <div class="sideTitle" style="height:25px;">
      <div style="float:left; vertical-align:middle; padding:5px 3px 5px 3px;">&nbsp;<strong><a href='<?php echo $g5[bbs_url]?>/good_group.php?gr_id=<?php echo $gr_id?>'><?php echo _t($gr_subject)?> <?php echo _t('그룹'); ?></a></strong></div>
      <div style="float:right; vertical-align:middle; padding:3px 5px 3px 3px;"><a href="<?php echo $g5[bbs_url]?>/good_group.php?gr_id=<?php echo $gr_id?>"><img src="<?php echo $latest_skin_url?>/img/more_good.gif" alt="more" style="border:0; vertical-align:middle;"></a></div>
   </div>
...
for ($i=0; $i<count($list); $i++) {
   ...
   <img src='{$latest_skin_url}/img/latest_icon.gif' align=absmiddle>&nbsp;";
	...
	if ($list[$i]['is_notice'])
		...
		echo "<font color=#444444>["._t($list[$i]['bo_subject'])."]</font> "; ///
		/// echo "<font color=#444444>[{$list[$i]['ca_name']}]</font> "; ///
