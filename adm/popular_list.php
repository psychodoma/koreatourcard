...
<a href="./excel.popular_list.php?sfl=<?php echo $sfl ?>&stx=<?php echo $stx ?>&date1=<?php echo $date1 ?>&date2=<?php echo $date2 ?>" style=' width:100px; height:30px; background:gray; color:white; text-decoration:none;'>

	<div style=' width:100px; height:30px; background:gray; color:white; text-decoration:none; text-align:center; line-height:30px; margin-bottom:10px;'  >엑셀다운</div>
