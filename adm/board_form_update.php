...
$sql_common = " gr_id               = '{$_POST['gr_id']}',
                ...
                bo_subject_ko_KR          = '{$_POST['bo_subject']}',
                bo_subject_en_US          = '{$_POST['bo_subject_en_US']}',
                bo_subject_ja_JP          = '{$_POST['bo_subject_ja_JP']}',
                bo_subject_zh_CN          = '{$_POST['bo_subject_zh_CN']}',
                bo_subject_zh_TW          = '{$_POST['bo_subject_zh_TW']}',
                bo_mobile_subject   = '{$_POST['bo_mobile_subject']}',
                bo_mobile_subject_ko_KR          = '{$_POST['bo_mobile_subject']}',
                bo_mobile_subject_en_US          = '{$_POST['bo_mobile_subject_en_US']}',
                bo_mobile_subject_ja_JP          = '{$_POST['bo_mobile_subject_ja_JP']}',
                bo_mobile_subject_zh_CN          = '{$_POST['bo_mobile_subject_zh_CN']}',
                bo_mobile_subject_zh_TW          = '{$_POST['bo_mobile_subject_zh_TW']}',
...
if ($w == '') {
    ...
    /*
        ...
        http://sir.kr/bbs/board.php?bo_table=g5_tiptech&wr_id=27207
    */
