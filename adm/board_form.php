...
<section id="anc_bo_basic">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td colspan="2">
                <input type="text" name="bo_subject" value="<?php echo get_text($board['bo_subject']) ?>" id="bo_subject" required class="required frm_input" size="120" >
                <input type="text" name="bo_subject_en_US" value="<?php echo get_text($board['bo_subject_en_US']) ?>" id="bo_subject" required class="required frm_input" size="120">
                <input type="text" name="bo_subject_ja_JP" value="<?php echo get_text($board['bo_subject_ja_JP']) ?>" id="bo_subject" required class="required frm_input" size="120">
                <input type="text" name="bo_subject_zh_CN" value="<?php echo get_text($board['bo_subject_zh_CN']) ?>" id="bo_subject" required class="required frm_input" size="120">
                <input type="text" name="bo_subject_zh_TW" value="<?php echo get_text($board['bo_subject_zh_TW']) ?>" id="bo_subject" required class="required frm_input" size="120">
            </td>
        </tr>
        <tr>
            ...
            <td colspan="2">
                ...
                <input type="text" name="bo_mobile_subject" value="<?php echo get_text($board['bo_mobile_subject']) ?>" id="bo_mobile_subject" class="frm_input" size="120">
                <input type="text" name="bo_mobile_subject_en_US" value="<?php echo get_text($board['bo_mobile_subject_en_US']) ?>" id="bo_mobile_subject" class="frm_input" size="120" >
                <input type="text" name="bo_mobile_subject_ja_JP" value="<?php echo get_text($board['bo_mobile_subject_ja_JP']) ?>" id="bo_mobile_subject" class="frm_input" size="120" >
                <input type="text" name="bo_mobile_subject_zh_CN" value="<?php echo get_text($board['bo_mobile_subject_zh_CN']) ?>" id="bo_mobile_subject" class="frm_input" size="120" >
                <input type="text" name="bo_mobile_subject_zh_TW" value="<?php echo get_text($board['bo_mobile_subject_zh_TW']) ?>" id="bo_mobile_subject" class="frm_input" size="120" >
            </td>
        </tr>
        <tr>
