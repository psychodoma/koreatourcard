...
$menu["menu500"] = array (
    array('500000', '판매점 관리', ''.G5_ADMIN_URL.'/bbs/board.php?bo_table=map', 'map'),
    array('500100', '판매점 관리', ''.G5_ADMIN_URL.'/bbs/board.php?bo_table=map', 'map'),
    array('500200', '전체 판매점 안내', ''.G5_ADMIN_URL.'/bbs/board.php?bo_table=allshop', 'allshop'), 
);
?>
