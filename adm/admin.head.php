...
<header id="hd">
    <div id="hd_wrap">
        ...
        <div id="logo"><a href="<?php echo G5_ADMIN_URL ?>"><img src="<?php echo G5_ADMIN_URL ?>/img/logo1.png" alt="<?php echo $config['cf_title'] ?> 관리자"></a></div>
...
<div id="wrapper">
    ...
    <div id="container">
        ...
        <h1 class='admin_title_h1'><?php echo $g5['title'] ?></h1>
