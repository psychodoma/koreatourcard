...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        <th scope="row"><label for="fa_order">분류</label></th>
        <td>
            <select name='fa_cate' id='fa_cate'>
                <option value='코리아투어카드 이용안내' <?if($fa['fa_cate'] == "코리아투어카드 이용안내") echo "selected"?> >코리아투어카드 이용안내</option>
                <option value='국내관광안내' <?if($fa['fa_cate'] == "국내관광안내") echo "selected"?> >국내관광안내</option>
                <option value='기타' <?if($fa['fa_cate'] == "기타") echo "selected"?> >기타</option>
            </select>
