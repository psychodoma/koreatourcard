...
function add_menu_list(name, link, code)
{
    ...
    list += '<label for="me_name_<?php echo $i; ?>" class="sound_only"><?php echo $sub_menu_info; ?> 메뉴<strong class="sound_only"> 필수</strong></label>';
    list += '<input type="text" name="me_url[]" value="<?php echo $me_url; ?>" id="me_name_<?php echo $i; ?>" required class="required frm_input full_input">';
    list += '</td>';
    list += "<td>";
