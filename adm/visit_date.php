...
?>
<a href="./excel.visit_date.php?fr_date=<?php echo $fr_date ?>&to_date=<?php echo $to_date ?>" style=' width:100px; height:30px; background:gray; color:white; text-decoration:none;'>
