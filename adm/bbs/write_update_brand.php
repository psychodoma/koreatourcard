...
if ($w == '' || $w == 'r') {
    ...
    $sql = " insert into $write_table
                set wr_num = '$wr_num',
                     ...
                     wr_10 = '$wr_10',
                     wr_waring = '$wr_waring',
                     wr_waring_en_US = '$wr_waring_en_US',
                     wr_waring_ja_JP = '$wr_waring_ja_JP',
                     wr_waring_zh_CN = '$wr_waring_zh_CN',
                     wr_waring_zh_TW = '$wr_waring_zh_TW',
                     wr_address_num = '$wr_address_num',
                     wr_address = '$wr_address',
                     wr_lat = '$wr_lat',
                     wr_lng = '$wr_lng',
                     wr_address_txt = '$wr_1' ' $wr_2',
                     wr_address_txt_en_US = '$wr_3' ' $wr_4',
                     wr_address_txt_ja_JP = '$wr_5' ' $wr_6',
                     wr_address_txt_zh_CN = '$wr_7' ' $wr_8',
                     wr_address_txt_zh_TW = '$wr_9' ' $wr_10',
                     wr_service = '$wr_service',
                     wr_service_en_US = '$wr_service_en_US',
                     wr_service_ja_JP = '$wr_service_ja_JP',
                     wr_service_zh_CN = '$wr_service_zh_CN',
                     wr_service_zh_TW = '$wr_service_zh_TW',
                     wr_title_ko_KR = '$wr_title_ko_KR',
                     wr_title_en_US = '$wr_title_en_US',
                     wr_title_ja_JP = '$wr_title_ja_JP',
                     wr_title_zh_CN = '$wr_title_zh_CN',
                     wr_title_zh_TW = '$wr_title_zh_TW',
                     wr_metro = '$metro',
                     wr_bus_1 = '$wr_bus_1',
                     wr_bus_2 = '$wr_bus_2',
                     wr_bus_3 = '$wr_bus_3',
                     ...
                     wr_bus_6 = '$wr_bus_6',
                     wr_bus_7 = '$wr_bus_7',
                     wr_bus_8_ko_KR = '$wr_bus_8_ko_KR',
					 wr_bus_8_en_US = '$wr_bus_8_en_US',
					 wr_bus_8_ja_JP = '$wr_bus_8_ja_JP',
					 wr_bus_8_zh_CN = '$wr_bus_8_zh_CN',
					 wr_bus_8_zh_TW = '$wr_bus_8_zh_TW',
                     wr_homepage_ko_KR = '$wr_homepage_ko_KR',
					 wr_homepage_en_US = '$wr_homepage_en_US',
					 wr_homepage_ja_JP = '$wr_homepage_ja_JP',
					 wr_homepage_zh_CN = '$wr_homepage_zh_CN',
					 wr_homepage_zh_TW = '$wr_homepage_zh_TW',
                     wr_group = '$wr_group',
                     wr_guide = '$wr_guide',
                     wr_guide_en_US = '$wr_guide_en_US',
                     wr_guide_ja_JP = '$wr_guide_ja_JP',
                     wr_guide_zh_CN = '$wr_guide_zh_CN',
                     wr_guide_zh_TW = '$wr_guide_zh_TW',
                     wr_local1_ko_KR= '$wr_local1_ko_KR',
                     wr_local2_ko_KR = '$wr_local2_ko_KR',
                     wr_bus_9_ko_KR = '$wr_bus_9_ko_KR',
					 wr_bus_9_en_US = '$wr_bus_9_en_US',
...
$j = $i-4;
    ...
    if ($row['cnt'])
    {
        ...
        else
        {
            ...
            $sql .= "   bf_content_zh_TW = '{$bf_content_zh_TW[$i]}'
                        where bo_table = '{$bo_table}'
                                  and wr_id = '{$wr_id}'
                                  and bf_no = '{$i}' ";
            sql_query($sql);
...
{
    $row2 = sql_fetch(" select bf_file, bf_content, bf_content_en_US, bf_content_ja_JP, bf_content_zh_CN, bf_content_zh_TW, bf_ck from {$g5['board_file_table']} where bo_table = '{$bo_table}' and wr_id = '{$wr_id}' and bf_no = '{$i}' ");

    // 정보가 있다면 빠집니다.
    if ($row2['bf_file']){  }
    else if ( strlen($row2['bf_content']) > 4 ) {  }
