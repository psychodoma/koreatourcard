...
//$file_current_cnt = sql_fetch("select count(*) cnt from g5_board_file where bo_table = '".$bo_table."' and wr_id =".$wr_id);
//echo "select count(*) cnt from g5_board_file where bo_table = ".$bo_table." and wr_id =".$wr_id;
//$file_current_cnt = $file_current_cnt['cnt']-1;
...
if ($w == '' || $w == 'r') {
    ...
    $sql = " insert into $write_table
                set wr_num = '$wr_num',
                     ...
                     wr_subject_ko_KR = '$wr_subject',
                     wr_subject_en_US = '$wr_subject_en_US',
                     wr_subject_ja_JP = '$wr_subject_ja_JP',
                     wr_subject_zh_CN = '$wr_subject_zh_CN',
                     wr_subject_zh_TW = '$wr_subject_zh_TW',
                     ...
                     wr_9 = '$wr_9',
                     wr_10 = '$wr_10',
                     wr_address_num = '$wr_address_num',
                     wr_address_ko_KR = '$wr_1' ' $wr_2',
                     wr_address_en_US = '$wr_3' ' $wr_4',
                     wr_address_ja_JP = '$wr_5' ' $wr_6',
                     wr_address_zh_CN = '$wr_7' ' $wr_8',
                     wr_address_zh_TW = '$wr_9' ' $wr_10',             
                     wr_metro_ko_KR = '$wr_metro_ko_KR',
                     wr_metro_en_US = '$wr_metro_en_US',
                     wr_metro_ja_JP = '$wr_metro_ja_JP',
                     wr_metro_zh_CN = '$wr_metro_zh_CN',
                     wr_metro_zh_TW = '$wr_metro_zh_TW',                    
                     wr_time_ko_KR = '$wr_time_ko_KR',
                     wr_time_en_US = '$wr_time_en_US',
                     wr_time_ja_JP = '$wr_time_ja_JP',
                     wr_time_zh_CN = '$wr_time_zh_CN',
                     wr_time_zh_TW = '$wr_time_zh_TW',
                     wr_recom_ko_KR = '$wr_recom_ko_KR',
                     wr_recom_en_US = '$wr_recom_en_US',
                     wr_recom_ja_JP = '$wr_recom_ja_JP',
                     wr_recom_zh_CN = '$wr_recom_zh_CN',
                     wr_recom_zh_TW = '$wr_recom_zh_TW',
                     wr_subway_ko_KR = '$wr_subway_ko_KR',
                     wr_subway_en_US = '$wr_subway_en_US',
                     wr_subway_ja_JP = '$wr_subway_ja_JP',
                     wr_subway_zh_CN = '$wr_subway_zh_CN',
                     wr_subway_zh_TW = '$wr_subway_zh_TW',
                     wr_near_ko_KR = '$wr_near_ko_KR',
                     wr_near_en_US = '$wr_near_en_US',
                     wr_near_ja_JP = '$wr_near_ja_JP',
                     wr_near_zh_CN = '$wr_near_zh_CN',
                     wr_near_zh_TW = '$wr_near_zh_TW',
                     wr_item_ko_KR = '$wr_item_ko_KR',
                     wr_item_en_US = '$wr_item_en_US',
                     wr_item_ja_JP = '$wr_item_ja_JP',
                     wr_item_zh_CN = '$wr_item_zh_CN',
                     wr_item_zh_TW = '$wr_item_zh_TW',
                     wr_main_ko_KR = '$wr_main_ko_KR',
                     wr_main_en_US = '$wr_main_en_US',
                     wr_main_ja_JP = '$wr_main_ja_JP',
                     wr_main_zh_CN = '$wr_main_zh_CN',
                     wr_main_zh_TW = '$wr_main_zh_TW',
                     wr_etc_ko_KR = '$wr_etc_ko_KR',
                     wr_etc_en_US = '$wr_etc_en_US',
                     wr_etc_ja_JP = '$wr_etc_ja_JP',
                     wr_etc_zh_CN = '$wr_etc_zh_CN',
                     wr_etc_zh_TW = '$wr_etc_zh_TW',
                     wr_lat = '$wr_lat',
                     wr_lng = '$wr_lng'";
    ...
    for ($i=0; $i<count($wr_metro); $i++){
        $sql_metro = " insert into g5_write_cardbenefit_metro set 
                            ...
                            metro_info = '$metro_info[$i]',
                            metro_info_en_US = '$metro_info_en_US[$i]',
    ...
    while ($metro_row = sql_fetch_array($metro_re)){
        if($metro_c == 0){
            $metro_c_str .= $metro_row['metro_id'];
        }else{
            $metro_c_str .= "|".$metro_row['metro_id'];
        }
        $metro_c++;
...
//$upload_content_cnt = count($_POST['bf_content']);
//$file_c = -$file_current_cnt;
        ...
        if ($upload[$i]['del_check'] || $upload[$i]['file'])
        {
            $sql = " update {$g5['board_file_table']}
                        set bf_source = '{$upload[$i]['source']}',
                             ...
                             bf_content_en_US = '{$bf_content_en_US[$i]}',
                             bf_content_ja_JP = '{$bf_content_ja_JP[$i]}',
                             bf_content_zh_CN = '{$bf_content_zh_CN[$i]}',
                             bf_content_zh_TW = '{$bf_content_zh_TW[$i]}',
...
{
    $row2 = sql_fetch(" select bf_file, bf_content from {$g5['board_file_table']} where bo_table = '{$bo_table}' and wr_id = '{$wr_id}' and bf_no = '{$i}' ");

    // 정보가 있다면 빠집니다.
    if ($row2['bf_file']) continue;
    else if ($row2['bf_content']) continue;
    // 그렇지 않다면 정보를 삭제합니다.
    sql_query(" delete from {$g5['board_file_table']} where bo_table = '{$bo_table}' and wr_id = '{$wr_id}' and bf_no = '{$i}' ");
}

    $row3 = sql_query(" select bf_file, bf_content, bf_no from {$g5['board_file_table']} where bo_table = '{$bo_table}' and wr_id = '{$wr_id}' order by bf_no");
    ...
    $row4 = sql_query(" select bf_file, bf_content, bf_no from {$g5['board_file_table']} where bo_table = '{$bo_table}' and wr_id = '{$wr_id}' order by bf_no");
    

    echo " select bf_file, bf_content, bf_no from {$g5['board_file_table']} where bo_table = '{$bo_table}' and wr_id = '{$wr_id}' order by bf_no";
    echo "<br>";
    $re_cnts1 = 0;
