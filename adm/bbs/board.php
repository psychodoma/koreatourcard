...
if (isset($wr_id) && $wr_id) {
    ...
    $g5['title'] = strip_tags(conv_subject(_t($write['wr_subject']), 255))." > ".((G5_IS_MOBILE && $board['bo_mobile_subject']) ? _t($board['bo_mobile_subject']) : _t($board['bo_subject']));
} else {
    ...
    $g5['title'] = ((G5_IS_MOBILE && $board['bo_mobile_subject']) ? _t($board['bo_mobile_subject']) : _t($board['bo_subject'])).' '.$page.' '._t('페이지');
}
