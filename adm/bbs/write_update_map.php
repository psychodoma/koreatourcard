...
if ($w == '' || $w == 'r') {
    ...
    // for($i=0; $i < count($info_phone); $i++){
    //     if($i == 0){
    //         $com_phone = $info_phone[$i];
    //     }else{
    //         $com_phone .= " - ".$info_phone[$i];
    //     }
    // }

    // for($i=0; $i < count($info_phone1); $i++){
    //     if($i == 0){
    //         $com_phone1 = $info_phone1[$i];
    //     }else{
    //         $com_phone1 .= " - ".$info_phone1[$i];
    //     }
    // }
    ...
    $sql = " insert into $write_table
                set wr_num = '$wr_num',
                     ...
                     wr_subject = '$info_name_ko_KR',
                     wr_content = '$info_name_ko_KR',
                     wr_link1 = '$wr_link1',
                     wr_link2 = '$wr_link2',
                     wr_link1_hit = 0,
                     wr_link2_hit = 0,
                     ...
                     wr_9 = '$wr_9',
                     wr_10 = '$wr_10', 
                     info_name_ko_KR = '$info_name_ko_KR',
                     info_name_en_US = '$info_name_en_US',
                     info_name_ja_JP = '$info_name_ja_JP',
                     info_name_zh_CN = '$info_name_zh_CN',
                     info_name_zh_TW = '$info_name_zh_TW',
                     info_address_ko_KR = '$wr_1' ' $wr_2',
                     info_address_en_US = '$wr_3' ' $wr_4',
                     info_address_ja_JP = '$wr_5' ' $wr_6',
                     info_address_zh_CN = '$wr_7' ' $wr_8',
                     info_address_zh_TW = '$wr_9' ' $wr_10',
                     info_address_num = '$info_address_num',
                     info_lat = '$info_lat',
                     info_lng = '$info_lng',
                     store_id = '$store_id',
                     info_phone = '$info_phone',
                     info_phone1 = '$info_phone1',
                     service_id = '$com_service',
                     info_servicetime_ko_KR = '$info_servicetime_ko_KR',
                     info_servicetime_en_US = '$info_servicetime_en_US',
                     info_servicetime_ja_JP = '$info_servicetime_ja_JP',
                     info_servicetime_zh_CN = '$info_servicetime_zh_CN',
                     info_servicetime_zh_TW = '$info_servicetime_zh_TW',
