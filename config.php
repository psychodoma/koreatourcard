...
define('GB_5_VERSION', '굿빌더'); /// old style
define('GB_VERSION', '굿빌더');

define('BUILDER_NAME', '굿빌더');
define('BUILDER_VERSION_CLASS', 'ML');
define('BUILDER_VERSION_NUMBER', '6.4.1');
define('BUILDER_VERSION_DATE', '2016.12.02');
define('BUILDER_HOME', 'http://www.goodbuilder.co.kr');

define('G5_VERSION', '그누보드5');
define('G5_GNUBOARD_VER', '5.2.4');
define('G5_YOUNGCART_VER', '5.2.4');
define('G5_GNUCONTENTS_VER', '1.0.b5');

define('ENABLE_MODULE_G5', false);
define('ENABLE_MODULE_ML', false);

/// g5 or multi language support
if(defined('ENABLE_MODULE_G5') && ENABLE_MODULE_G5 && file_exists(dirname(__FILE__).'/module/g5/bbs') && file_exists(dirname(__FILE__).'/module/g5/lib')) {
define('BBS_NAME', 'module/g5/bbs');
define('LIB_NAME', 'module/g5/lib');
define('JS_NAME', 'module/g5/js');
} else if(defined('ENABLE_MODULE_ML') && ENABLE_MODULE_ML && file_exists(dirname(__FILE__).'/module/ml/bbs') && file_exists(dirname(__FILE__).'/module/ml/lib')) {
define('BBS_NAME', 'module/ml/bbs');
define('LIB_NAME', 'module/ml/lib');
define('JS_NAME', 'module/ml/js');
} else {
define('BBS_NAME', 'bbs');
define('LIB_NAME', 'lib');
define('JS_NAME', 'js');
...
/// index title comment
///$index_title_comment = "::: 사이트 설명";
$index_title_comment = "";

/// g4 support

// Show/Hide of sub menus
/// $ShowHideType            = ""; // 'default', 'simple', 'simple_timeout', 'timeout' 
$ShowHideType                = "timeout"; // 'default', 'simple', 'simple_timeout', 'timeout' 
$site_name                   = ""; // 여기에 사이트 네임 지정시 관리자 설정보다 우선 적용됨
$va                          = ".v";

define('POWERED_BY', 1); /// allow powered_by link
define('DESIGNED_BY', 1); /// allow designed_by link
