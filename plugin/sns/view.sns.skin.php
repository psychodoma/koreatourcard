...
<li><a href="<?php echo $facebook_url; ?>" target="_blank"><img src="/img/sub/Btn_facebook.jpg" alt="<?=_t('페이스북')?>"/></a></li>
<li><a href="<?php echo $twitter_url; ?>" target="_blank"><img src="/img/sub/Btn_twit.jpg" alt="<?=_t('트위터')?>"/></a></li>
