...
function editor1_html($id, $content, $is_dhtml_editor=true, $type)
{
    global $g5, $config;
    static $js = true;
    ...
    $smarteditor_class = $is_dhtml_editor ? "smarteditor2" : "";
    $html .= "\n<div>".$type."</div><textarea id=\"$id\" name=\"$id\" class=\"$smarteditor_class\" maxlength=\"65536\" style=\"width:330px;height:100px\">$content</textarea>";
    $html .= "\n<span class=\"sound_only\">웹 에디터 끝</span>";
    return $html;
}

function editor4_html($id, $content, $is_dhtml_editor=true)
{
    global $g5, $config;
    static $js = true;
