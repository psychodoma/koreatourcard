						...
						<tr>
							...
							<td class="sub22_td2">
								<div class="sub22_board_info">
									<h3 style='color:#333;' ><?=$row['wr_subject_'.$_SESSION['lang']]?></h3>
									<p><?=$str_content?></p>
								</div>
							</td>
						</tr>
